...
def generate_audio_multilang( # 用來處理多語言的
    slices,
    sdp_ratio,
    noise_scale,
    noise_scale_w,
...
def process_mix(slice): # 用來處理混合語言的
    _speaker = slice.pop()
    _text, _lang = [], []
...
def process_auto(text): # 用來處理自動判斷語言的
    _text, _lang = [], []
