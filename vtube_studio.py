...
class VTSController:
    def __init__(self,port:int=9886, pluginName:str='AI-Waifu-test', pluginDeveloper:str='JarikDem-Bot') -> None:
        self.base_info = {
...
async def main():
    ...
    while True:
        await vtsc.inject_params([['VoiceVolume', 0.0]])
        await asyncio.sleep(10)
        await vtsc.inject_params([['VoiceVolume', 1.0]])
        await asyncio.sleep(10)
